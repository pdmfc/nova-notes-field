<template>
    ...
    <a href="#"
       ...
       data-testid="users-items-0-view-button" dusk="1-view-button" data-original-title="null">
        ...
        <div class="absolute px-2 py-1 rounded-full text-white text-xs bg-primary font-bold pin-t pin-l ml-4 -mt-3">1</div>
    </a>
</template>
