        ...
        <li class="flex text-left bg-indigo overflow-hidden px-4 py-4">
          ...
          <div>
              <div class="flex space-x-2">
                  ...
                  <svg v-if="data.personal" class="h-5 w-5 self-center" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div class="mt-6 flex">
              ...
              <div>
                <h4 class="text-lg font-semibold">Lorem ipsum</h4>
                <p class="mt-1">
